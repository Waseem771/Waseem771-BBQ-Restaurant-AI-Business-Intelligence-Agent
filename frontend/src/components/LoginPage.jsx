...
import { Eye, EyeOff, Flame, User, Lock, ShieldCheck } from 'lucide-react';
...
export default function LoginPage({ onLoginSuccess }) {
  ...
  const handleDemoLogin = async () => {
    ...
    setError('');
    try {
      const sessionData = await authService.login('demo', 'demo');
      ...
      authService.storeSession(demo, false);
      onLoginSuccess?.(demo);
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="login-form-section">
          <div className="login-form-wrapper">
            ...
            >
              ...
              <br />
              Username: <code style={{ background: 'rgba(99,102,241,0.12)', padding: '1px 5px', borderRadius: 4 }}>waseem</code>
              &nbsp;|&nbsp;
              Password: <code style={{ background: 'rgba(99,102,241,0.12)', padding: '1px 5px', borderRadius: 4 }}>iba@123</code>
            </div>
